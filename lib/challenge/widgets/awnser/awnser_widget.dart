...
class AwnserWidget extends StatelessWidget {
  ...
  const AwnserWidget({
    ...
    Color get _selectedBorderColorRight => awnser.isRight ? AppColors.lightGreen : AppColors.lightRed;
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.fromBorderSide(
                      BorderSide(
                        color: isSelected ? _selectedBorderColorRight : AppColors.border,
                      ))
                  ),
